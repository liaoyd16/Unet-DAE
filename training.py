...
if __name__=="__main__":
    ...
    for t in range(ITER2):
        ...
        top = model.upward(source, a5, a4, a3, a2, a1)
        ...
        #     if OBS < 32: OBS *= 2
            ...
            # spec = source[0].view(128, 128).detach().numpy()
            # cv2.imwrite(training_result+"m_source_{}.png".format(t), spec * 255)

            # y1 = recover[0].view(128, 128).detach().numpy()
            # cv2.imwrite(training_result+"m_y1_{}.png".format(t), y1 * 255)

            # targ = clean[0].view(128, 128).detach().numpy()
            # cv2.imwrite(training_result+"m_clean_{}.png".format(t), targ * 255)
